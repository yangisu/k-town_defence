...
const allowedRoutes = [
  ...
  { method: "POST", pattern: /^api\/v1\/expeditions$/ },
  { method: "GET", pattern: /^api\/v1\/expeditions\/current$/ },
  { method: "GET", pattern: new RegExp(`^api/v1/expeditions/${UUID}$`) },
  { method: "POST", pattern: new RegExp(`^api/v1/expeditions/${UUID}/(?:abandon|complete)$`) },
