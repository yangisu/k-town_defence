...
class ExpeditionStopModel(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            name="ck_expedition_stop_kind",
        ),
        CheckConstraint(
            "placement IN ('before', 'main', 'between', 'after')",
            name="ck_expedition_stop_placement",
        ),
        CheckConstraint(
            ...
            name="ck_expedition_stop_semantics",
        ),
    )
    ...
    stop_kind: Mapped[str] = mapped_column(String(20), default="anchor")
    is_required: Mapped[bool] = mapped_column(Boolean, default=True)
    placement: Mapped[str] = mapped_column(String(20), default="main")
